...
public class VentanaAgregarLibro extends javax.swing.JFrame {
    ...
    public VentanaAgregarLibro(Usuario user,Conexion con) throws IOException {
        initComponents();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            if (Acceso.addLibro(titulo.toLowerCase(), autor.toLowerCase(), añoDePublicacion, genero.toLowerCase())) {
                ...
                JOptionPane.showMessageDialog(null, "Libro ya existente en la biblioteca");
            }
        } catch (Exception e) {
