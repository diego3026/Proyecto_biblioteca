...
public class ConexionLibrosPrestadosHistoria {

    FileWriter fileWrite;
    PrintWriter printWrite;

    public ConexionLibrosPrestadosHistoria() throws IOException {
        fileWrite = new FileWriter("librosPrestadosHistoria.txt", true);
    ...
    public String leerDatos() throws IOException {
        FileReader fileReader = new FileReader("librosPrestadosHistoria.txt");
    ...
    public void removeDatos(String titulo) throws IOException {
        ...
        fileWrite = new FileWriter("librosPrestadosHistoria.txt");
        printWrite = new PrintWriter(fileWrite);
